...
from tensorflow.keras.preprocessing.image import ImageDataGenerator # This is the typical import
from tensorflow.keras.models import Sequential, Model, load_model
from tensorflow.keras.layers import Conv2D, MaxPooling2D, Flatten, Dense, Dropout, BatchNormalization, GlobalAveragePooling2D
from tensorflow.keras.initializers import GlorotNormal
from tensorflow.keras.callbacks import ReduceLROnPlateau, ModelCheckpoint, EarlyStopping
from tensorflow.keras.optimizers import Adam
# from keras.models import load_model # Potentially remove if fully using tf.keras
# from keras.preprocessing.image import load_img, img_to_array # Use tf.keras.utils equivalents
...
def predict_labels_and_display(model_path, test_dir='/test', image_size=(224, 224)):
    ...
    # load the best model
    best_model = tf.keras.models.load_model(model_path) # Ensure using tf.keras.models.load_model
